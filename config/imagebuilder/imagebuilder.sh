...
rebuild_firmware() {
    ...
    my_packages="\
        libc libubus20220601 libnettle8 kmod-ipt-ipset libnetfilter-conntrack3 dnsmasq-full \
        ...
        uclient-fetch uhttpd uhttpd-mod-ubus unzip uqmi usb-modeswitch kmod-usb2 uuidgen wget-ssl whereis \
        usbutils htop nano screen \
